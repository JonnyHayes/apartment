...
!function($){
  ...
  // Overwrite to center image, half of 3772px
  var centerWidth = -1024;
    ...
    return this.each(function(){
      ...
      el.find("> img").load(function () {
        ...
        el.find(".pv-inner").css({
          ...
          'background-position': centerWidth + 'px 0px',
        })
        ...
        function reset (){
            start = {x: centerWidth, y: 0};
            $(this).css('backgroundPosition', centerWidth + 'px 0');
        }
